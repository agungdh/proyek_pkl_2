...
<div class="box box-primary">
    ...
    <form method="get" action="<?php echo base_url('laporan/filter'); ?>">
        ...
        <label for="tahun_ajar">Tahun Ajar</label><br>
          <input value="<?php echo substr($cthnajar, 0, 4); ?>" required type="number" min="2000" max="2900" class="" id="tahun_ajar_awal" placeholder="Isi Tahun Ajar" name="tahun_ajar_awal" style="height: 34px; background: #f2f2f2; border: none;">
          /
        <input readonly value="<?php echo substr($cthnajar, 4, 4); ?>" required type="number" min="2000" max="2900" class="" id="tahun_ajar_akhir" placeholder="Isi Tahun Ajar" name="tahun_ajar_akhir" style="height: 34px; background: #f2f2f2; border: none;">
